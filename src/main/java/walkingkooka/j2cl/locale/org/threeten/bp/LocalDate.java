...
import walkingkooka.j2cl.locale.org.threeten.bp.chrono.IsoChronology;
import walkingkooka.j2cl.locale.org.threeten.bp.jdk8.Jdk8Methods;
import walkingkooka.j2cl.locale.org.threeten.bp.temporal.TemporalAdjusters.RelativeDayOfWeek;

import java.io.DataInput;
import java.io.DataOutput;
import java.io.IOException;

import static walkingkooka.j2cl.locale.org.threeten.bp.temporal.ChronoField.DAY_OF_MONTH;
import static walkingkooka.j2cl.locale.org.threeten.bp.temporal.ChronoField.EPOCH_DAY;
import static walkingkooka.j2cl.locale.org.threeten.bp.temporal.ChronoField.MONTH_OF_YEAR;
import static walkingkooka.j2cl.locale.org.threeten.bp.temporal.ChronoField.YEAR;
...
//    //-----------------------------------------------------------------------
    ...
    private static LocalDate create(int year, Month month, int dayOfMonth) {
        ...
        if (dayOfMonth > 28 && dayOfMonth > month.length(IsoChronology.isLeapYear(year))) {
            if (dayOfMonth == 29) {
...
//    }
    ...
    public LocalDate with(final RelativeDayOfWeek adjuster) {
